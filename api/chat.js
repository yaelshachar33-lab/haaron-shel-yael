...
- כשאת ממליצה על פריט שתואם בדיוק למה שהגולשת ביקשה (סוג + צבע + מאפיינים), הוסיפי תג: [PRODUCT_ID:X] כאשר X הוא המספר שמופיע ב-ID של הפריט ברשימה. אפשר עד 3 תגים. אם הפריט לא תואם במדויק — אל תוסיפי תג. דוגמה: ביקשו שמלה אדומה ואין → אל תוסיפי תג בכלל`
