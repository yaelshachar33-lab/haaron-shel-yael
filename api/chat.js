...
- כשאת מזכירה פריט ספציפי שקיים ברשימה, הוסיפי בסוף התשובה תג בפורמט: [PRODUCT:שם הפריט]. חובה: העתיקי את השם בדיוק מהשדה "שם" ברשימת הפריטים — אות באות, ללא שינוי. אפשר עד 3 תגים. אם לא מזכירה פריט ספציפי, או שאת לא בטוחה מה השם המדויק — אל תוסיפי תג בכלל`
