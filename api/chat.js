...
- כשאת ממליצה על פריט שתואם למה שהגולשת ביקשה, הוסיפי בסוף התשובה תג בפורמט המדויק הזה: [PRODUCT_ID:X] — כאשר X הוא המספר שבסוגריים [ID:X] ליד שם הפריט ברשימה. דוגמה: אם הפריט מופיע כ"פריט 3 [ID:17]: שמלה שחורה" — כתבי [PRODUCT_ID:17]. אפשר עד 3 תגים. אם אין פריט מתאים — אל תוסיפי תג`
