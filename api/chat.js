...
- כשאת מזכירה פריט ספציפי שקיים ברשימה, הוסיפי בסוף התשובה תג בפורמט: [PRODUCT:שם הפריט בדיוק כפי שכתוב ברשימה]. אפשר עד 3 תגים. אם לא מזכירה פריט ספציפי — אל תוסיפי תג בכלל`
